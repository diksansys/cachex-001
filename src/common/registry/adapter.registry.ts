import { primaryCacheAdapter } from "../adapters/cache.primary.adapter";
import { primaryDbAdapter } from "../adapters/db.primary.adapter";
import { primaryWriteStreamAdapter } from "../adapters/writestream.primary.adapter";
